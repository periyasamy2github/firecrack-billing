...
export const shop: Shop = {
  ...
  town: 'Thiruthangal',
  addressLine: '142, Sivakasi Main Road, Thiruthangal, Virudhunagar — 626130, Tamil Nadu',
  phone: '04562 224 118',
  gstin: '33AABCS1429P1Z8',
  stateCode: '33-Tamil Nadu',
  invoicePrefix: 'SMF/26-27/',
  nextInvoiceNumber: 1483,
  declaration:
    'Goods once sold will not be taken back. Fireworks to be stored and used per PESO safety norms. Subject to Virudhunagar jurisdiction.',
  seasonTarget: 40_00_000,
}

// Counters. Super Admin oversees and manages all of them; staff are mapped to one or more.
export const branches: Branch[] = [
  { id: 'c1', name: 'Counter 1 — Entrance', active: true },
  { id: 'c2', name: 'Counter 2 — Main hall', active: true },
  { id: 'c3', name: 'Counter 3 — Wholesale desk', active: true },
]
